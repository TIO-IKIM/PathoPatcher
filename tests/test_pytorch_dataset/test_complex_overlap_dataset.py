...
class TestPreProcessorComplexOverlapDataset(unittest.TestCase):
    """Compare disk dataset with in memory dataset for a complex setup with overlap"""

    @classmethod
    def setUpClass(cls) -> None:
        """Setup configuration"""
        check_test_database()
        cls.config = "./tests/static_test_files/preprocessing/complex_overlap_dataset/config.yaml"
