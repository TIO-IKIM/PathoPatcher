...
class TestPreProcessorBaselineDataset(unittest.TestCase):
    """Compare disk dataset with in memory dataset for a basic setup"""
    ...
    def setUpClass(cls) -> None:
        ...
        check_test_database()
        cls.config = (
            "./tests/static_test_files/preprocessing/baseline_dataset/config.yaml"
        )
        ...
        cls.patch_config = LivePatchWSIConfig(
            ...
            downsample=cls.configuration.downsample,
            patch_size=cls.configuration.patch_size,
        )
