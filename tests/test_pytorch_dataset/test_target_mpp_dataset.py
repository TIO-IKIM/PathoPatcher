...
class TestPreProcessorTargetMPPDataset(unittest.TestCase):
    """Compare disk dataset with in memory dataset with selecting target microns per pixel"""
    ...
    def setUpClass(cls) -> None:
        ...
        check_test_database()
        cls.config = (
            "./tests/static_test_files/preprocessing/target_mpp_dataset/config.yaml"
        )
