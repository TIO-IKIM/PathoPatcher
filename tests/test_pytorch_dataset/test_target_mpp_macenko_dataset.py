...
class TestPreProcessorTargetMPPMacenkoDataset(unittest.TestCase):
    """Compare disk dataset with in memory dataset with selecting target microns per pixel and Macenko normalization"""

    @classmethod
    def setUpClass(cls) -> None:
        """Setup configuration"""
        check_test_database()
        cls.config = "./tests/static_test_files/preprocessing/target_mpp_macenko_dataset/config.yaml"
